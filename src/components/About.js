        ...
        <>
            <body style={{
                ...
                <div className="container">
                    ...
                    <h3>Our Mission</h3>
                    <p>Our mission is to make the process of booking FIFA tickets as easy and enjoyable as possible. We understand the excitement and anticipation that comes with attending a FIFA match, and we're here to enhance that experience for you.</p>

                    <h3>Key Features</h3>
                    <ul>
                        <li>Easy match selection: Choose from a variety of exciting matches featuring top teams from around the world.</li>
                        <li>Simple booking process: Our user-friendly interface allows you to book tickets in just a few clicks.</li>
                    ...
                    <p>Email: priyanshbhavsar492@gmail.com</p>
