    ...
    return (
        <>
            <body style={{
                ...
                <marquee style={{ color: 'white' }} width='82%' direction="right">
                    Welcome to FIFA Ticket Booking System - Your One-Stop Destination for Football Excitement!
                </marquee>
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-sm">
                            <div className="card bg-secondary text-white" style={{ width: '49rem' }}>
                                <img className="card-img-right" src={book} alt="Card image cap" />
                        ...
                        <div className="col-sm">
                            <div className="card  bg-secondary text-white" style={{ width: '22rem' }}>
                                <img className="card-img-right" src={schedule} alt="Card image cap" />
                                <div className="card-body">
                            ...
                            <br />
                            <div className="card bg-secondary text-white" style={{ width: '22rem' }}>
                                <img className="card-img-right" src={scorecard} alt="Card image cap" />
                                <div className="card-body">
